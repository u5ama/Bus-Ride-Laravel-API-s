    ...
    <div class="breadcrumb-header justify-content-between">
        ...
        <div class="d-flex my-xl-auto right-content">
            <div class="pr-1 mb-3 mb-xl-0">
                <a href="{{ route('admin.bus_stations.create') }}" class="btn btn-primary  mr-2">
...
@section('js')
    <script>
        const sweetalert_title = "DELETE BUS STATION?";
    ...
    <script src="{{URL::asset('assets/js/custom/bus_station.js')}}"></script>
@endsection
