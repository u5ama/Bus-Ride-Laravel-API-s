...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h2 class="content-title mb-0 my-auto">Withdraw Requests</h2>
...
@section('js')
    <script>
        const sweetalert_title = "DELETE WITHDRAW REQUEST?";
    ...
    <script src="{{URL::asset('assets/js/custom/withdraw_req.js')}}"></script>
@endsection
