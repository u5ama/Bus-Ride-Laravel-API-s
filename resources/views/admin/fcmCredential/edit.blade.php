...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h2 class="content-title mb-0 my-auto">{{ config('languageString.edit_fcm_credential') }}</h2>
            ...
            <div class="card">
                <div class="card-body">
                    <form method="POST" data-parsley-validate="" id="addEditForm" role="form">
                        @csrf
                        <input type="hidden" id="edit_value" name="edit_value" value="{{ $fcmCredential->id }}">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                           name="project_name" value="{{$fcmCredential->project_name}}"
                                           id="project_name"
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="server_key">{{ config('languageString.server_key') }}<span
                                            class="error">*</span></label>
                                    <input type="text" class="form-control"
                                           name="server_key" value="{{$fcmCredential->server_key}}"
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                           ...
                                           id="sender_id" value="{{$fcmCredential->sender_id}}"
