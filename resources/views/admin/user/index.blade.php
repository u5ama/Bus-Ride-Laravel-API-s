...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h2 class="content-title mb-0 my-auto">{{ config('languageString.user') }}</h2>
                    ...
                    <div class="table-responsive">
                        <table class="table mg-b-0 text-md-nowrap" id="data-table">
                            ...
                            <tr>
                                ...
                                <th>{{ config('languageString.gender') }}</th>
...
@section('js')
    <script>
        const sweetalert_title = "DELETE USER?";
    ...
    <script src="{{URL::asset('assets/js/custom/user.js')}}"></script>
@endsection
