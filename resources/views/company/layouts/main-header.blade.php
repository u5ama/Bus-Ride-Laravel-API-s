            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    <a class="profile-user d-flex" href="">
                        <img alt="" src="{{URL::asset(auth()->guard('company')->user()->com_logo)}}">
                    </a>
                    <div class="dropdown-menu">
                        <div class="main-header-profile bg-primary p-3">
                            <div class="d-flex wd-100p">
                                <div class="main-img-user">
                                    <img alt="" src="{{URL::asset(auth()->guard('company')->user()->com_logo)}}" class="">
                                </div>
                                <div class="ml-3 my-auto">
                                    <h6>{{ auth()->guard('company')->user()->com_name }}</h6>
                                </div>
                            </div>
                        </div>
                        <a class="dropdown-item" href="{{ route('company.profile',[1]) }}"><i
                                class="bx bx-slider-alt"></i> Profile</a>
                        @if(auth()->guard('company')->user()->com_panel_mode==2)
