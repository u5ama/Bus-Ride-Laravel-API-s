...
class Utility
{
    ...
    public static function timeAndDistance($lat1,$long1,$lat2,$long2){
        ...
        $response = \Curl::to('https://maps.googleapis.com/maps/api/directions/json?origin='.$lat1.','.$long1.'&destination='.$lat2.','.$long2.'&sensor=false&mode=driving&key=AIzaSyBSNGN0Ra0EjIWfHDsL0Jm5HGsBl3aDols')
            ->get();
