...
class DriverResource extends JsonResource
{
    ...
    {
        if ($this->DriverCurrentLocation->dcl_app_active == 1){
            $assignBus = AssignBuses::where(['driver_id' => $this->id, 'status' => 'active'])->first();
            if($assignBus){
        ...
        return [
            ...
            'bus_name'=>(isset($bus) && $bus != null) ? $bus->name : "",
            'bus_reg_number'=>(isset($bus) && $bus != null) ? $bus->reg_number : "",
            'bus_color'=>(isset($bus) && $bus != null) ? $bus->bus_color : "",
            'bus_total_seats'=>(isset($bus) && $bus != null) ? $bus->total_seats : "",
            'bus_current_seats'=>(isset($bus) && $bus != null) ? $bus->current_seats : "",
            'bus_per_seat_charge'=>(isset($bus) && $bus != null) ? number_format((float)$bus->per_seat_charge, 2, '.', '') : '0.00',
